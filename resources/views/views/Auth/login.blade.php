...
<div class="page-wraper">
	...
	<div class="account-form">
		<div class="account-head" style="background-image:url(assets/images/background/bg2.png);">
			<a href=""><h2 style="color: cornsilk;"> Fleet Io</h2></a>
		</div>
				...
				@csrf
					...
					<div class="row placeani">
						...
						<div class="col-lg-12 m-b30">
							<button name="submit"  value="Submit" class="btn button-md">Login</button>
							<a href = "register" class="btn button-md twitter">Register</a>
						</div>
						<div class="col-lg-12">
